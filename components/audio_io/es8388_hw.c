...
#define ES8388_DACCONTROL24    0x08
#define ES8388_DACCONTROL25    0x08
...
W(ES8388_DACCONTROL27, 0x14);
        ...
        W(ES8388_ADCCONTROL1, 0x88); /* lower mic PGA gain to reduce int16 clipping */
        W(ES8388_ADCCONTROL2, 0x00);
        W(ES8388_ADCCONTROL3, 0x02);
        W(ES8388_ADCCONTROL4, 0x0c);
        W(ES8388_ADCCONTROL5, 0x02);
        W(ES8388_ADCCONTROL8, 0x18);
        W(ES8388_ADCCONTROL9, 0x18);
